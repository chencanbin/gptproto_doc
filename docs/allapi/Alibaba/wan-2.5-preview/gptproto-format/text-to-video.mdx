---
title: 'Wan-2.5-Preview ｜ Text To Video ｜ GPTProto API'
sidebarTitle: 'Text to Video'
api: 'POST /api/v3/alibaba/wan-2.5-preview/text-to-video'
description: 'Bring stories to life with wan 2.5 preview text to video. High-quality cinematic generation with consistent characters and fluid motion from text prompts.'
mode: 'wide'
---
...
Generate videos from text prompts using Qwen's wan-2.5-preview model with GPTProto format API.

<CodeGroup>

```bash cURL
curl --location 'https://gptproto.com/api/v3/alibaba/wan-2.5-preview/text-to-video' \
...
url = "https://gptproto.com/api/v3/alibaba/wan-2.5-preview/text-to-video"
headers = {
...
const url = "https://gptproto.com/api/v3/alibaba/wan-2.5-preview/text-to-video";
const headers = {
  "Authorization": "YOUR_API_KEY",
  "Content-Type": "application/json"
};

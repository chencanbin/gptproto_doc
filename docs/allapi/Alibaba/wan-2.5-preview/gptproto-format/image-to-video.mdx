---
title: 'Wan-2.5-Preview ｜ Image To Video ｜ GPTProto API'
sidebarTitle: 'Image to Video'
api: 'POST /api/v3/alibaba/wan-2.5-preview/image-to-video-fast'
description: 'Animate static shots using wan 2.5 preview image to video technology. Create cinematic motion and high-fidelity video clips from any single source image.'
mode: 'wide'
---

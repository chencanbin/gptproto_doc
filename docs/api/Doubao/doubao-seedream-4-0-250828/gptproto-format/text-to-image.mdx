...
```bash cURL
curl --location 'https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-image' \
...
url = "https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-image"
headers = {
    "Authorization": "sk-xx",
...
const url = "https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-image";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};

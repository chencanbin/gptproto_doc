---
title: 'Runwayml-Gen3a_turbo-5 - Query Task'
sidebarTitle: 'Query Task'
api: 'GET /runway/v1/tasks/{task_id}'
description: 'Runwayml-Gen3a_turbo-5 — Query Task. GPTProto API reference.'
mode: 'wide'
---
...
url = "https://gptproto.com/runway/v1/tasks/{task_id}"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/runway/v1/tasks/{task_id}";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};

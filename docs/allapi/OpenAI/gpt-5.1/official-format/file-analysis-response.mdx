---
title: 'GPT-5.1 ｜ File Analysis ｜ Response ｜ GPTProto API'
sidebarTitle: 'File Analysis (Response)'
api: 'POST https://gptproto.com/v1/responses'
description: 'Next-gen gpt 5.1 file analysis. Superior document understanding and extraction for the most demanding research tasks.'
mode: 'wide'
---

---
title: 'Seedance-1-0-Pro-250528 ｜ Image To Video ｜ GPTProto API'
sidebarTitle: 'Image to Video'
api: "POST /api/v3/bytedance/doubao-seedance-1-0-pro-250528/image-to-video"
description: 'Master Seedance-1-0-Pro for high-quality AI video generation. Explore pricing, technical specs, and integration tips on GPTProto. Start creating today!'
keywords:
  - 'Seedance-1-0-Pro'
  - 'AI video generator'
  - 'Seedance API'

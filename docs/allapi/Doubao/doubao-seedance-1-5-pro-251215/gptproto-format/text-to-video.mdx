...
api: 'POST https://gptproto.com/api/v3/bytedance/doubao-seedance-1-5-pro-251215/text-to-video'
description: ''
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-5-pro-251215/text-to-video' \

---
title: 'Veo3-Fast - Text To Video - gptproto'
sidebarTitle: 'Text to Video'
api: 'POST /api/v3/google/veo3-fast/text-to-video'
description: 'Veo3-Fast — Text To Video (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
Google Veo3-fast's GPTProto format for the text to video API.

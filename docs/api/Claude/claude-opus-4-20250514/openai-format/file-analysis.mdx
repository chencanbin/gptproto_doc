---
title: 'Claude-Opus-4-20250514 - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-Opus-4-20250514 — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-20250514` | The model to use for file analysis. Must be `claude-opus-4-20250514` or another Claude model with file analysis capabilities. |

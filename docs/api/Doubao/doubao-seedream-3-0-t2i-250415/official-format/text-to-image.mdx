---
title: 'Doubao-Seedream-3-0-T2i-250415 - Text To Image'
sidebarTitle: 'Text to Image '
api: 'POST /api/v3/images/generations'
description: 'Doubao-Seedream-3-0-T2i-250415 — Text To Image. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `doubao-seedream-3-0-t2i-250415` | The model identifier for image generation/editing |

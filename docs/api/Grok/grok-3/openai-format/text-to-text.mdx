---
title: 'Grok-3 - Text To Text - openai'
sidebarTitle: 'text to text'
api: 'POST /v1/chat/completions'
description: 'Grok-3 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `grok` | The model to use for the request. `grok` |

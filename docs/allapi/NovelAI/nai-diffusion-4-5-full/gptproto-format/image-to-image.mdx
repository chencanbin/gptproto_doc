---
title: 'Nai-Diffusion-4-5-Full ｜ Image To Image ｜ GPTProto API'
sidebarTitle: 'Image To Image'
api: 'POST https://gptproto.com/api/v3/novel/nai-diffusion-4-5-curated/image-to-image'
description: 'Try NovelAI Diffusion V4.5 Full on GPT Proto, state-of-the-art diffusion model for generating high-resolution images from text prompts.'
keywords:

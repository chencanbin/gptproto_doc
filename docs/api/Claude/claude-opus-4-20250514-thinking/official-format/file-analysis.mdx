---
title: 'Claude-Opus-4-20250514-Thinking - File Analysis'
sidebarTitle: 'File Analysis'
api: 'POST /v1/messages'
description: 'Claude-Opus-4-20250514-Thinking — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-20250514-thinking` | The model to use for file analysis |

...
description: 'Claude-Haiku-4-5-20251001 — Web Search (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-haiku-4-5-20251001` | The model to use for the request |

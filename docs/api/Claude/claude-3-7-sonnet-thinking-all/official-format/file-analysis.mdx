---
title: 'Claude-3-7-Sonnet-Thinking-All - File Analysis'
sidebarTitle: 'File Analysis'
api: 'POST /v1/messages'
description: 'Claude-3-7-Sonnet-Thinking-All — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-thinking-all` | The model to use for file analysis |

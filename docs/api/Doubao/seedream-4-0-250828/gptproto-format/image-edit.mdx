---
title: 'Seedream-4-0-250828 - Image Edit - gptproto'
sidebarTitle: 'Image Edit'
api: 'POST /api/v3/bytedance/seedream-4-0-250828/image-edit'
description: 'Seedream-4-0-250828 — Image Edit (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/seedream-4-0-250828/image-edit' \
...
url = "https://gptproto.com/api/v3/bytedance/seedream-4-0-250828/image-edit"
headers = {
    "Authorization": "sk-xx",
...
const url = "https://gptproto.com/api/v3/bytedance/seedream-4-0-250828/image-edit";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};
...
| `images` | array | ✅ Yes | `[&quot;https://d1q70pf5vjeyhc.cloudfront.net/media/92d2d4ca66f84793adcb20742b15d262/images/1757414555847323990_Si8cqCBF.jpeg&quot;]` | Input image URL(s) for image-to-image generation |

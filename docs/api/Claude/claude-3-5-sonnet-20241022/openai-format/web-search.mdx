---
title: 'Claude-3-5-Sonnet-20241022 - Web Search - openai'
sidebarTitle: 'Web Search'
api: 'POST /v1/chat/completions'
description: 'Claude-3-5-Sonnet-20241022 — Web Search (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-5-sonnet-20241022` | The model to use for the request |

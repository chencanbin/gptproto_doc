---
title: 'O4-Mini-Deep-Research ｜ File Analysis ｜ Response ｜ GPTProto API'
sidebarTitle: 'File Analysis (Response)'
api: 'POST https://gptproto.com/v1/responses'
description: 'Fast o4 mini deep research file analysis. Intensive document parsing and data extraction at high speeds.'
mode: 'wide'
---

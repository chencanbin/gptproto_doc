---
title: 'Doubao-Seedance-1-5-Pro-251215 - Image To Video - gptproto'
sidebarTitle: 'Image to Video'
api: "POST /api/v3/bytedance/doubao-seedance-1-5-pro-251215/image-to-video"
description: 'Elite doubao seedance 1.5 pro image to video. Create lifelike animations and professional motion graphics from your existing photos.'
keywords:
  - 'doubao seedance 1.5 pro'
  - 'doubao seedance 1.5 pro api'
  - 'doubao seedance'
mode: 'wide'
---
...
```bash cURL
curl --location --request POST 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-5-pro-251215/image-to-video' \
...
url = "https://gptproto.com/api/v3/bytedance/doubao-seedance-1-5-pro-251215/image-to-video"
...
const url = 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-5-pro-251215/image-to-video';

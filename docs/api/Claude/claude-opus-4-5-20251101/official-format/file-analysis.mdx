...
description: 'Claude-Opus-4-5-20251101 — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-5-20251101` | - | The model identifier. Use `claude-opus-4-5-20251101` for this model |

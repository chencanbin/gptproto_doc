---
title: 'Speech-2.5-Turbo-Preview-Voice-Clone - Voice To Voice - gptproto'
sidebarTitle: 'Voice Clone'
api: 'POST /api/v3/minimax/voice-clone'
description: 'Speech-2.5-Turbo-Preview-Voice-Clone — Voice To Voice (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
| `model` | string | ✅ Yes | `speech-2.5-turbo-preview-voice-clone` | Specify the TTS model to be used for the preview. This is only a preview after cloning. Once the model is generated, any Minimax Turbo or HD voice model can be used for inference. |

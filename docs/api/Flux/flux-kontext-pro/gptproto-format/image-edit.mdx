---
title: 'Flux-Kontext-Pro - Image Edit - gptproto'
sidebarTitle: 'Image Edit'
api: 'POST /v1/images/generations'
description: 'Flux-Kontext-Pro — Image Edit (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
| `model` | string | ✅ Yes | `flux-kontext-pro` | The model to use for the request |

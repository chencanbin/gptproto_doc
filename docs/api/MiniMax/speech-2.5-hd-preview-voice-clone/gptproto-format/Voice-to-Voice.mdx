---
title: 'Speech-2.5-Hd-Preview-Voice-Clone - Voice To Voice - gptproto'
sidebarTitle: 'Voice Clone'
api: 'POST /api/v3/minimax/voice-clone'
description: 'Speech-2.5-Hd-Preview-Voice-Clone — Voice To Voice (gptproto). GPTProto API reference.'
mode: 'wide'
---

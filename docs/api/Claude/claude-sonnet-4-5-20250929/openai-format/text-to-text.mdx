---
title: 'Claude-Sonnet-4-5-20250929 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-Sonnet-4-5-20250929 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-5-20250929` | - | The model to use for the request. `claude-sonnet-4-5-20250929` |
...
| `max_tokens` | integer | ❌ No | - | 1-64000 | Maximum number of tokens to generate in the response |

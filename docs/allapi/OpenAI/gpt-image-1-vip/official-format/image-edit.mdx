---
title: 'GPT-Image-1-Vip ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/v1/images/edits'
description: 'VIP gpt image 1 image edit. High-end AI tools for professional photography retouching and visual design.'
mode: 'wide'
---

---
title: 'Deepseek-V3 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Deepseek-V3 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
Deepseek's openai format for the text to text API.
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `deepseek-v3` | The model to use for the request. `deepseek-v3` |

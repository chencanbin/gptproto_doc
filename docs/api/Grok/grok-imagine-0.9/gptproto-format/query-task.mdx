---
title: 'Grok-Imagine-0.9 - Query Task - gptproto'
sidebarTitle: 'Query Task'
api: 'GET /api/v3/predictions/{task_id}/result'
description: 'Grok-Imagine-0.9 — Query Task (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
Grok's GPTProto format for the query task API.

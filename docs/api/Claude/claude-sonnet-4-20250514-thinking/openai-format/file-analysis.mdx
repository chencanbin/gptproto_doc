---
title: 'Claude-Sonnet-4-20250514-Thinking - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-Sonnet-4-20250514-Thinking — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-20250514-thinking` | The model to use for file analysis. Must be `claude-sonnet-4-20250514-thinking` or another Claude model with file analysis capabilities. |

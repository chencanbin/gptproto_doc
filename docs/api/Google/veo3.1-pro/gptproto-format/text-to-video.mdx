---
title: 'Veo3.1-Pro - Text To Video - gptproto'
sidebarTitle: 'Text to Video'
api: 'POST /api/v3/google/veo3.1-pro/text-to-video'
description: 'Veo3.1-Pro — Text To Video (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
Google Veo3.1-pro's GPTProto format for the text to video API.
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/google/veo3.1-pro/text-to-video' \
...
url = "https://gptproto.com/api/v3/google/veo3.1-pro/text-to-video"
headers = {
...
const url = "https://gptproto.com/api/v3/google/veo3.1-pro/text-to-video";
const headers = {
  "Authorization": "Bearer sk-xxxxxx",
  "Content-Type": "application/json"
};
...
- Use the [Query Task](docs/api/google/veo3.1-pro/gptproto-format/query-task) endpoint to check generation status

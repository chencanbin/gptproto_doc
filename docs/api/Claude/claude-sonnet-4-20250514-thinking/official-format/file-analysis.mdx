...
description: 'Claude-Sonnet-4-20250514-Thinking — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-20250514-thinking` | The model to use for file analysis |

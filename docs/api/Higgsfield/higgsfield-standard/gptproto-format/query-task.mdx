---
title: 'Higgsfield-Standard - Query Task - gptproto'
sidebarTitle: 'query task '
api: 'GET /v1/higgsfield/:task_id'
description: 'Higgsfield-Standard — Query Task (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
url = "https://gptproto.com/v1/higgsfield/{task_id}"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1/higgsfield/{task_id}";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};

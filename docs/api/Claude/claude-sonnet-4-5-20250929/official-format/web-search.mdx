---
title: 'Claude-Sonnet-4-5-20250929 - Web Search'
sidebarTitle: 'Web Search'
api: 'POST /v1/messages'
description: 'Claude-Sonnet-4-5-20250929 — Web Search. GPTProto API reference.'
mode: 'wide'
---
...
| `messages` | array | ✅ Yes | `[{'role': 'user', 'content': "What's the weather in NYC?"}]` | - | Array of message objects for the conversation. Each message must have a `role` (user/assistant) and `content`. See [Messages Structure](#messages-array-structure) below for details |

---
title: 'Flux-Kontext-Max - Submit Task'
sidebarTitle: 'Submit Task'
api: 'POST /flux/v1/flux-kontext-max'
description: 'Flux-Kontext-Max — Submit Task. GPTProto API reference.'
mode: 'wide'
---
...
Flux's official format for the submit task API for Flux Kontext Max.

<CodeGroup>

```bash cURL
curl --location --request POST 'https://gptproto.com/flux/v1/flux-kontext-max' \

---
title: 'Claude-3-7-Sonnet-20250219-Thinking - File Analysis'
sidebarTitle: 'File Analysis'
api: 'POST /v1/messages'
description: 'Claude-3-7-Sonnet-20250219-Thinking — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-20250219-thinking` | The model to use for file analysis |

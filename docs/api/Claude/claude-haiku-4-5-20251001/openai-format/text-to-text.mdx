---
title: 'Claude-Haiku-4-5-20251001 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-Haiku-4-5-20251001 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `claude-haiku-4-5-20251001` | - | The model to use for the request. `claude-haiku-4-5-20251001` |
...
| `max_tokens` | integer | ✅ Yes | - | 1-8192 | Maximum number of tokens to generate in the response |

---
title: 'Claude-3-7-Sonnet-All - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-3-7-Sonnet-All — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-all` | The model to use for the request. `claude-3-7-sonnet-all` |

---
title: 'Doubao-Seededit-3-0-I2i-250628 - Image Edit'
sidebarTitle: 'Image Edit'
api: 'POST /api/v3/images/generations'
description: 'Doubao-Seededit-3-0-I2i-250628 — Image Edit. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `doubao-seededit-3-0-i2i-250628` | The model identifier for image generation/editing |

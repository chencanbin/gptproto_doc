---
title: 'Claude-Sonnet-4-5-20250929-Thinking - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-Sonnet-4-5-20250929-Thinking — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-5-20250929-thinking` | The model to use for file analysis. Must be `claude-sonnet-4-5-20250929-thinking` or another Claude model with file analysis capabilities. |

---
title: 'Suno-Music - Text To Audio'
sidebarTitle: 'Text to Audio'
api: 'POST /v1/suno/submit/music'
description: 'Suno-Music — Text To Audio. GPTProto API reference.'
mode: 'wide'
---
...
1. **Check Task Status** - Query the [Task Status endpoint](docs/api/Suno/suno-music/official-format/query-task) to monitor progress
...
- [Query Task Status](docs/api/Suno/suno-music/official-format/query-task) - Check generation progress and retrieve audio

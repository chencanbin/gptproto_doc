---
title: 'GPT-Image-2-Plus ｜ Image Edit'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/v1/images/edits'
description: 'Clean gpt image 1 image edit. Fast and effective AI-powered photo editing for everyday creative needs.'
keywords:
...
data.append('model', 'gpt-image-2-plus');
...
dataList.append(encode("gpt-image-2-plus"))
dataList.append(encode('--' + boundary))
...
func main() {
  ...
  _ = writer.WriteField("model", "gpt-image-2-plus")

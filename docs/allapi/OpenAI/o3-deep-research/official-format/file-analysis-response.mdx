---
title: 'O3-Deep-Research ｜ File Analysis ｜ Response ｜ GPTProto API'
sidebarTitle: 'File Analysis (Response)'
api: 'POST https://gptproto.com/v1/responses'
description: 'Intense o3 deep research file analysis. Thoroughly audit and analyze massive files with advanced multi-step logic.'
mode: 'wide'
---

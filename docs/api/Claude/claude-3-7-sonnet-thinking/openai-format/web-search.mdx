---
title: 'Claude-3-7-Sonnet-Thinking - Web Search - openai'
sidebarTitle: 'Web Search'
api: 'POST /v1/chat/completions'
description: 'Claude-3-7-Sonnet-Thinking — Web Search (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-thinking` | The model to use for the request |

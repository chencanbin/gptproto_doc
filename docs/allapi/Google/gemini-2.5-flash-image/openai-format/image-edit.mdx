---
title: 'Gemini-2.5-Flash-Image ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/v1/images/edits'
description: 'Optimize your creative AI workflows with Gemini-2.5-Flash-Image. Learn about photo prompts, API integration, and cost-effective scaling on GPTProto. Start no…'
keywords:
...
data.append('model', 'gemini-2.5-flash-image');
...
dataList.append(encode("gemini-2.5-flash-image"))
dataList.append(encode('--' + boundary))
...
func main() {
  ...
  _ = writer.WriteField("model", "gemini-2.5-flash-image")

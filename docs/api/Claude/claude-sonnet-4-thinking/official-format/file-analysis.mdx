---
title: 'Claude-Sonnet-4-Thinking - File Analysis'
sidebarTitle: 'File Analysis'
api: 'POST /v1/messages'
description: 'Claude-Sonnet-4-Thinking — File Analysis. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-thinking` | The model to use for file analysis |

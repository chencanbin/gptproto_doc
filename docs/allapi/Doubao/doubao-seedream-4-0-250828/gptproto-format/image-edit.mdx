---
title: 'Doubao-Seedream-4-0-250828 ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/api/v3/bytedance/doubao-seedream-4-0-250828/image-edit'
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/doubao-seedream-4-0-250828/image-edit' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/bytedance/doubao-seedream-4-0-250828/image-edit',
  headers: { 

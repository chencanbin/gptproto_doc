---
title: 'Claude-3-5-Haiku-20241022 - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-3-5-Haiku-20241022 — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-5-haiku-20241022` | The model to use for file analysis. Must be `claude-3-5-haiku-20241022` or another Claude model with file analysis capabilities. |

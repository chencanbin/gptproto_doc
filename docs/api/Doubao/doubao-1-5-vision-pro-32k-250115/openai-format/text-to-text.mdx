---
title: 'Doubao-1-5-Vision-Pro-32k-250115 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Doubao-1-5-Vision-Pro-32k-250115 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
BytePlus's openai format for the text to text API.
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `doubao-1-5-vision-pro-32k-250115` | The model to use for the request. `doubao-1-5-vision-pro-32k-250115` |

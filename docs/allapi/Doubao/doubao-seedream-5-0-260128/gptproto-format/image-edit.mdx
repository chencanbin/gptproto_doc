---
title: 'Doubao-Seedream-5-0-260128 ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/api/v3/bytedance/doubao-seedream-5-0-260128/image-edit'
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/doubao-seedream-5-0-260128/image-edit' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/bytedance/doubao-seedream-5-0-260128/image-edit',
  headers: { 

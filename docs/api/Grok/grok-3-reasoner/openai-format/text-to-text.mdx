---
title: 'Grok-3-Reasoner - Text To Text - openai'
sidebarTitle: 'text to text'
api: 'POST /v1/chat/completions'
description: 'Grok-3-Reasoner — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `grok-3-reasoner` | The model to use for the request. `grok-3-reasoner` |

---
title: 'Seededit-3-0-I2i-250628 - Image Edit - gptproto'
sidebarTitle: 'Image Edit'
api: 'POST /v1/images/generations'
description: 'Seededit-3-0-I2i-250628 — Image Edit (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/seededit-3-0-i2i-250628/image-edit' \
...
url = "https://gptproto.com/api/v3/bytedance/seededit-3-0-i2i-250628/image-edit"
headers = {
    "Authorization": "sk-xx",
...
const url = "https://gptproto.com/api/v3/bytedance/seededit-3-0-i2i-250628/image-edit";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};

---
title: 'Doubao-1-5-Vision-Pro-32k-250115 - Text To Text'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Doubao-1-5-Vision-Pro-32k-250115 — Text To Text. GPTProto API reference.'
mode: 'wide'
---
...
BytePlus's official format for the text to text API.

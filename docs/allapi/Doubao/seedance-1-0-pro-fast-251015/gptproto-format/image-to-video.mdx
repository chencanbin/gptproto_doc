---
title: 'Seedance-1-0-Pro-Fast-251015 - Image To Video - gptproto'
sidebarTitle: 'Image to Video'
api: "POST /api/v3/bytedance/doubao-seedance-1-0-pro-fast-251015/image-to-video"
description: 'High-speed seedance 1.0 pro fast image to video. Pro-level animation results in half the time for rapid creative workflows.'
mode: 'wide'
---
...
```bash cURL
curl --location --request POST 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-pro-fast-251015/image-to-video' \
...
url = "https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-pro-fast-251015/image-to-video"
...
const url = 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-pro-fast-251015/image-to-video';

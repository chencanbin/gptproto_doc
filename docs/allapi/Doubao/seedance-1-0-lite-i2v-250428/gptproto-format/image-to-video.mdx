---
title: 'Seedance-1-0-Lite-I2v-250428 - Image To Video - gptproto'
sidebarTitle: 'Image to Video'
api: "POST /api/v3/bytedance/doubao-seedance-1-0-lite-i2v-250428/image-to-video"
description: 'Fast seedance 1.0 lite image to video. Quickly turn photos into engaging animations and short clips with efficient AI processing.'
keywords:
...
```bash cURL
curl --location --request POST 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-lite-i2v-250428/image-to-video' \
...
url = "https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-lite-i2v-250428/image-to-video"
...
const url = 'https://gptproto.com/api/v3/bytedance/doubao-seedance-1-0-lite-i2v-250428/image-to-video';

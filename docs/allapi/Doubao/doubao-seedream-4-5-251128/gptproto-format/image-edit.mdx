---
title: 'Doubao-Seedream-4-5-251128 ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/api/v3/bytedance/doubao-seedream-4-5-251128/image-edit'
description: 'Try Doubao Seedream 4.5 API on GPT Proto. Generate high-quality, detailed, and styled visuals from text prompts for creatives and illustrations.'
keywords:
  - 'doubao-seedream-4-5-251128'
  - 'doubao-seedream-4-5-251128 api'
  - 'doubao seedream 4.5'
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/doubao-seedream-4-5-251128/image-edit' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/bytedance/doubao-seedream-4-5-251128/image-edit',
  headers: { 

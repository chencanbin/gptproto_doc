---
title: 'Claude-3-7-Sonnet-20250219-Thinking - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-3-7-Sonnet-20250219-Thinking — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---

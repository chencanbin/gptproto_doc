...
description: 'Doubao-Seedream-4-0-250828 — Text To Image (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-imgae' \
...
url = "https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-imgae"
headers = {
    "Authorization": "sk-xx",
...
const url = "https://gptproto.com/api/v3/doubao/seedream-4-0-250828/text-to-imgae";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};

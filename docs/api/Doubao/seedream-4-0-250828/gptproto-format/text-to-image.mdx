...
api: 'POST /api/v3/doubao/seedream-4-0-250828/text-to-image'
description: 'Seedream-4-0-250828 — Text To Image (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
const url = "https://gptproto.com/api/v3/bytedance/seedream-4-0-250828/text-to-image";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};

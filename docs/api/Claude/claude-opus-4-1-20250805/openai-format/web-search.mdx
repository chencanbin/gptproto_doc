...
description: 'Claude-Opus-4-1-20250805 — Web Search (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-1-20250805` | The model to use for the request |

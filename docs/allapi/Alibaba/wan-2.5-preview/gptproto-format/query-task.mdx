---
title: 'Wan-2.5-Preview ｜ Query Task ｜ GPTProto API'
sidebarTitle: 'Query Task'
api: 'GET /api/v3/predictions/{task_id}/result'
description: 'Optimize complex workflows with wan 2.5 preview query task capabilities. Precise data extraction and logical analysis for demanding technical requirements.'
mode: 'wide'
---

---
title: 'Seedream-5-0-260128 ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/api/v3/bytedance/seedream-5-0-260128/image-edit'
description: 'Unlock high-fidelity AI artistry with seedream-5-0-260128/text-to-image on GPT Proto. Professional grade rendering for enterprise visual workflows.'
keywords:
  - 'seedream-5-0-260128/text-to-image'
  - 'AI image generation'
  - 'photorealistic AI'
  - 'professional text-to-image'
  - 'GPT Proto visual models'
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/seedream-5-0-260128/image-edit' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/bytedance/seedream-5-0-260128/image-edit',
  headers: { 

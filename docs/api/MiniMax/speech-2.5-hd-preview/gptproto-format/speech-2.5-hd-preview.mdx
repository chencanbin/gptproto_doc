---
title: 'Speech-2.5-Hd-Preview - Speech 2.5 Hd Preview - gptproto'
sidebarTitle: 'speech-2.5-hd-preview'
api: 'POST /api/v3/minimax/speech-2.5-hd-preview'
description: 'Speech-2.5-Hd-Preview — Speech 2.5 Hd Preview (gptproto). GPTProto API reference.'
mode: 'wide'
---

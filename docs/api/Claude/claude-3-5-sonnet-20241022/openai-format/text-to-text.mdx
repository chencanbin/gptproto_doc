---
title: 'Claude-3-5-Sonnet-20241022 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-3-5-Sonnet-20241022 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-5-sonnet-20241022` | The model to use for the request. `claude-3-5-sonnet-20241022` |

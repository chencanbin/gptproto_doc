...
api: 'POST https://gptproto.com/api/v3/bytedance/dreamina-seedance-2-0-260128/text-to-video'
description: ''
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/dreamina-seedance-2-0-260128/text-to-video' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/bytedance/dreamina-seedance-2-0-260128/text-to-video',
  headers: { 

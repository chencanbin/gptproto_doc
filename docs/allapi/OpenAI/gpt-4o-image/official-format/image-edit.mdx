---
title: 'GPT-4o-Image ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/v1/images/edits'
description: 'Creative gpt 4o image edit. Versatile AI photo editing for style changes, object removal, and visual enhancements.'
mode: 'wide'
---
...
dataList.append(encode("gpt-4o-image"))
dataList.append(encode('--' + boundary))

---
title: 'Claude-Opus-4-1-20250805 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-Opus-4-1-20250805 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-1-20250805` | - | The model to use for the request. `claude-opus-4-1-20250805` |
...
| `max_tokens` | integer | ✅ Yes | - | 1-32000 | Maximum number of tokens to generate in the response |

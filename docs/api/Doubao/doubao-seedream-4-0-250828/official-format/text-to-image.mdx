...
description: 'Doubao-Seedream-4-0-250828 — Text To Image. GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `doubao-seedream-4-0-250828` | - | The model identifier for image generation/editing |

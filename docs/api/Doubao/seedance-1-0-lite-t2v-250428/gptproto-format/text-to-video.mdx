...
description: 'Seedance-1-0-Lite-T2v-250428 — Text To Video (gptproto). GPTProto API reference.'
mode: 'wide'
---
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/bytedance/seedance-1-0-lite-t2v-250428/image-to-video' \
...
url = "https://gptproto.com/api/v3/bytedance/seedance-1-0-lite-t2v-250428/image-to-video"
headers = {
    "Authorization": "sk-xx",
...
const url = "https://gptproto.com/api/v3/bytedance/seedance-1-0-lite-t2v-250428/image-to-video";
const headers = {
  "Authorization": "sk-xx",
  "Content-Type": "application/json"
};

---
title: 'Claude-3-7-Sonnet-20250219 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Claude-3-7-Sonnet-20250219 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-20250219` | The model to use for the request. `claude-3-7-sonnet-20250219` |

...
description: 'Claude-Opus-4-5-20251101 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-5-20251101` | - | The model to use for the request. `claude-opus-4-5-20251101` |

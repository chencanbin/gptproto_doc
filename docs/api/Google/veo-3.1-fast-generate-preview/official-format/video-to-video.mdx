...
description: 'Veo-3.1-Fast-Generate-Preview — Video To Video. GPTProto API reference.'
mode: 'wide'
---
    ...
    "instances": [
        {
            "prompt": "a dog",
            "video": {
                "uri": "https://api.gptproto.com/upload/v1beta/files/u5t03mc3obyv:download?alt=media"
            }
        }
    ],
    "parameters": {

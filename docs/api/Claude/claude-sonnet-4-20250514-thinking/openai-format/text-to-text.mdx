...
description: 'Claude-Sonnet-4-20250514-Thinking — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-sonnet-4-20250514-thinking` | The model to use for the request. `claude-sonnet-4-20250514-thinking` |

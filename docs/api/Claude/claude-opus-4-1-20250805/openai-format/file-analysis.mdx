---
title: 'Claude-Opus-4-1-20250805 - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-Opus-4-1-20250805 — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4-1-20250805` | The model to use for file analysis. Must be `claude-opus-4-1-20250805` or another Claude model with file analysis capabilities. |

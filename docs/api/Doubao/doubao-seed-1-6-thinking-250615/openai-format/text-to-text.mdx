---
title: 'Doubao-Seed-1-6-Thinking-250615 - Text To Text - openai'
sidebarTitle: 'Text to Text'
api: 'POST /v1/chat/completions'
description: 'Doubao-Seed-1-6-Thinking-250615 — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `doubao-seed-1-6-thinking-250615` | The model to use for the request. `doubao-seed-1-6-thinking-250615` |

---
title: 'Claude-3-7-Sonnet-20250219-Thinking - File Analysis - openai'
sidebarTitle: 'File Analysis'
api: 'POST /v1/chat/completions'
description: 'Claude-3-7-Sonnet-20250219-Thinking — File Analysis (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-3-7-sonnet-20250219-thinking` | The model to use for file analysis. Must be `claude-3-7-sonnet-20250219-thinking` or another Claude model with file analysis capabilities. |

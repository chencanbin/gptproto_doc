---
title: 'GPT-4o-Image-Vip ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/v1/images/edits'
description: 'VIP gpt 4o image edit. Premium AI tools for professional-grade photo manipulation and exclusive artistic effects.'
mode: 'wide'
---
...
data.append('model', 'gpt-4o-image-vip');
...
dataList.append(encode("gpt-4o-image-vip"))
dataList.append(encode('--' + boundary))
...
func main() {
  ...
  _ = writer.WriteField("model", "gpt-4o-image-vip")

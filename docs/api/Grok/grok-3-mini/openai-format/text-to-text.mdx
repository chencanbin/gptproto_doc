---
title: 'Grok-3-Mini - Text To Text - openai'
sidebarTitle: 'text to text'
api: 'POST /v1/chat/completions'
description: 'Grok-3-Mini — Text To Text (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `grok-3-mini` | The model to use for the request. `grok-3-mini` |

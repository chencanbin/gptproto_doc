---
title: 'Seedream-4-0-250828 ｜ Image Edit ｜ GPTProto API'
sidebarTitle: 'Image Edit'
api: 'POST https://gptproto.com/api/v3/bytedance/seedream-4-0-250828/image-edit'
description: 'Generate hyper-realistic, uncensored visuals with Seedream 4.0. Perfect for fashion models and social media. Get started with our flexible API today!'
keywords:
  - 'Seedream 4.0'
  - 'Seedream 4.0 AI'
  - 'Seedream 4.0 API'

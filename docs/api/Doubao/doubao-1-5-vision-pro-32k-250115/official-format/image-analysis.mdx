---
title: 'Doubao-1-5-Vision-Pro-32k-250115 - Image Analysis'
sidebarTitle: 'Image Analysis'
api: 'POST /v1/chat/completions'
description: 'Doubao-1-5-Vision-Pro-32k-250115 — Image Analysis. GPTProto API reference.'
mode: 'wide'
---
...
BytePlus's official format for the image analysis API.

---
title: 'Claude-Opus-4 - Web Search - openai'
sidebarTitle: 'Web Search'
api: 'POST /v1/chat/completions'
description: 'Claude-Opus-4 — Web Search (openai). GPTProto API reference.'
mode: 'wide'
---
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-opus-4` | The model to use for the request |
